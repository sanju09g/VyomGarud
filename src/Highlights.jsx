        ...
        <div className="highlights-container">
          ...
          <div className="highlights-grid">
            <div className="highlight-box fade-box">
              ...
              <p>
                Tested across defense, surveillance, and mapping environments.
              </p>
            </div>
            ...
            <div className="highlight-box fade-box">
              ...
              <p>
                Path planning, obstacle avoidance, and intelligent decision
                making.
              </p>
            </div>
            ...
            <div className="highlight-box fade-box">
              ...
              <p>
                Tough composite body, weather-resistant, and field-proven
                durability.
              </p>
            </div>
            ...
            <div className="highlight-box fade-box">
              ...
              <p>
                Encrypted telemetry, HD video, and advanced analytics pipeline.
              </p>
            </div>
            ...
            <div className="highlight-box fade-box">
              ...
              <p>
                Multi-sensor support including EO-IR, LiDAR, and thermal
                imaging.
              </p>
            </div>
          </div>
          ...
          <div className="metrics fade-up">
            ...
            <ul>
              <li>
                <strong>Range:</strong> Up to 15 km
              </li>
              <li>
                <strong>Top Speed:</strong> 85 km/h
              </li>
              <li>
                <strong>Wind Resistance:</strong> Up to 40 km/h
              </li>
              <li>
                <strong>Payload Capacity:</strong> 2.5 kg
              </li>
              <li>
                <strong>Operational Altitude:</strong> 400+ m AGL
              </li>
            </ul>
          </div>
          ...
          <div className="awards fade-up">
            ...
            <div className="award-list">
              ...
              <div className="award-card">
                Defense Tech Certification Level-1
              </div>
            </div>
          </div>
          ...
          <div className="highlight-cta fade-up">
            ...
            <p>
              Explore drones engineered for precision, reliability & intelligent
              missions.
            </p>
